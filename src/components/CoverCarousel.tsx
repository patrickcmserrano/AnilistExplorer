  ...
  return (
    <>
      ...
      >
        ...
        {/* Info Overlay - Top */}
        {showInfo && (
          <div className="absolute top-0 left-0 right-0 bg-gradient-to-b from-black/80 to-transparent p-4 md:p-6 transition-opacity duration-300">
        ...
        <button
          ...
          className={`absolute left-4 top-1/2 -translate-y-1/2 p-3 rounded-full bg-black/50 text-white hover:bg-black/80 transition-all disabled:opacity-30 disabled:cursor-not-allowed ${isHovering ? 'opacity-100' : 'opacity-0 group-hover:opacity-100'
            }`}
        ...
        <button
          onClick={nextImage}
          disabled={availableImages.length <= 1}
          className={`absolute right-4 top-1/2 -translate-y-1/2 p-3 rounded-full bg-black/50 text-white hover:bg-black/80 transition-all disabled:opacity-30 disabled:cursor-not-allowed ${isHovering ? 'opacity-100' : 'opacity-0 group-hover:opacity-100'
            }`}
        ...
        <button
          onClick={prevAnime}
          className={`absolute top-4 left-1/2 -translate-x-1/2 p-2 rounded-full bg-purple-600/80 text-white hover:bg-purple-700 transition-all ${isHovering ? 'opacity-100' : 'opacity-0 group-hover:opacity-100'
            }`}
        ...
        <button
          onClick={nextAnime}
          className={`absolute bottom-20 left-1/2 -translate-x-1/2 p-2 rounded-full bg-purple-600/80 text-white hover:bg-purple-700 transition-all ${isHovering ? 'opacity-100' : 'opacity-0 group-hover:opacity-100'
            }`}
        ...
        <div
          className={`absolute top-4 right-4 flex gap-2 transition-opacity duration-300 ${isHovering ? 'opacity-100' : 'opacity-0 group-hover:opacity-100'
            }`}
        >
          {/* Info Toggle */}
          <button
